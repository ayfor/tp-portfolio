			...
			<div className='mx-auto max-w-full px-2 sm:px-6 lg:px-8'>
				<div className='relative flex h-16 items-center justify-between my-2'>
					...
					<div className='flex flex-1 items-center justify-center'>
						<div className='hidden w-full flex-row justify-end items-center sm:mx-6 2xl:flex'>
							<div className='w-1/4 flex justify-between space-x-4'>
								{navigation.map((item) => (
									<button
										key={item.name}
										className='text-primary font-medium bg-white px-4 py-2 rounded-lg w-1/4 transition duration-150 ease-in-out hover:scale-125'
