		...
		<section className='absolute w-full h-screen z-40'>
			<main className='flex items-center justify-center mx-4 mt-32 px-4 sm:px-6 lg:mt-32 lg:px-8 xl:mt-64'>
				<div className='sm:text-left md:text-center text-primary'>
					...
					<h1 className='sm:my-12 text-5xl font-bold md:text-8xl font-display'>
						<span className='text-emerald-600'>TWIN SPRUCE </span> STUDIO
					</h1>
					...
					<div className='mt-5 sm:mt-8 sm:flex sm:justify-center'>
						<div className='rounded-md mx-2'>
							<a
								href='#'
								className='flex w-full items-center justify-center rounded-md border-2 border-transparent transition ease-in-out hover:scale-110 bg-emerald-600 px-8 py-3 text-base font-medium text-white hover:bg-emerald-700 md:py-4 md:px-10 md:text-lg'
							>
								Contact Me
						...
						<div className='rounded-md mx-2'>
							<a
								href='#'
								className='group flex w-full items-center justify-center rounded-md border-2 border-emerald-600 transition ease-in-out hover:scale-105 bg-transparent px-8 py-3 font-semibold text-emerald-600 hover:bg-emerald-700 hover:text-white md:py-4 md:px-10 md:text-lg'
							>
								Download Resume
