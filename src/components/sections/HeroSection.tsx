...
const HeroSection = () => {
	return (
		<section className='absolute w-full h-screen z-40'>
			<main className='flex items-center justify-center mx-4 mt-32 px-4 sm:px-6 lg:mt-32 lg:px-8 2xl:mt-64'>
				<div className='text-center text-primary'>
					...
					{/* <h1 className='my-3 text-6xl font-black md:text-8xl font-display'>twin spruce</h1> */}
					<Image src='/tstypelogo.svg' alt='Twin Spruce Logo' width={850} height={200} />
					...
					<div className='mt-5 sm:mt-8 sm:flex sm:justify-center'>
						<div className='rounded-md m-2'>
							...
							>
								Contact Me
								<ArrowRightIcon className='w-6 h-6 ml-4 transition ease-in-out group-hover:translate-x-3' aria-hidden='true' />
							</a>
						</div>
